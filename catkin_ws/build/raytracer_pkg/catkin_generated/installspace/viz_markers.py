...
#			print(trans.transform.rotation)
			...
			try:
				trans2 = tf_buffer.lookup_transform('world', 'wall_frame', rospy.Time()) # frames from, to
				q = [trans2.transform.rotation.x, trans2.transform.rotation.y, trans2.transform.rotation.z, trans2.transform.rotation.w]
				tr_mat_w2wo = np.matrix(quaternion_matrix(q))
				tr_mat_w2wo[0,3] = trans2.transform.translation.x
				tr_mat_w2wo[1,3] = trans2.transform.translation.y
				tr_mat_w2wo[2,3] = trans2.transform.translation.z
				
				#tr_mat = np.asarray(tr_mat @ tr_mat_w2wo)
